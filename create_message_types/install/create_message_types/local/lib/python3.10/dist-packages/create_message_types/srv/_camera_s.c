...
bool create_message_types__srv__camera__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("create_message_types.srv._camera.Camera_Request", full_classname_dest, 47) == 0);
  }
  create_message_types__srv__Camera_Request * ros_message = _ros_message;
  {  // camera_name
...
PyObject * create_message_types__srv__camera__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("create_message_types.srv._camera");
...
ROSIDL_GENERATOR_C_EXPORT
bool create_message_types__srv__camera__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("create_message_types.srv._camera.Camera_Response", full_classname_dest, 48) == 0);
  }
  create_message_types__srv__Camera_Response * ros_message = _ros_message;
  {  // result
