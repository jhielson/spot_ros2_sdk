...
#include "create_message_types/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = create_message_types::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const create_message_types::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<create_message_types::msg::Num *>(
    untyped_ros_message);
...
{
  return &create_message_types::msg::typesupport_fastrtps_cpp::_Num__handle;
}
