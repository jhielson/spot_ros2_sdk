...
#include "create_message_types/srv/detail/camera__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = create_message_types::srv::Camera_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const create_message_types::srv::Camera_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<create_message_types::srv::Camera_Request *>(
    untyped_ros_message);
...
{
  return &create_message_types::srv::typesupport_fastrtps_cpp::_Camera_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = create_message_types::srv::Camera_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const create_message_types::srv::Camera_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<create_message_types::srv::Camera_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &create_message_types::srv::typesupport_fastrtps_cpp::_Camera_Response__handle;
}
...
{
  return &create_message_types::srv::typesupport_fastrtps_cpp::_Camera__handle;
}
