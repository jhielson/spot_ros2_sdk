...
#include "create_message_types/srv/detail/camera__rosidl_typesupport_fastrtps_c.h"
...
using _Camera_Request__ros_msg_type = create_message_types__srv__Camera_Request;
...
size_t get_serialized_size_create_message_types__srv__Camera_Request(
  const void * untyped_ros_message,
...
static uint32_t _Camera_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_create_message_types__srv__Camera_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_create_message_types
size_t max_serialized_size_create_message_types__srv__Camera_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = create_message_types__srv__Camera_Request;
    is_plain =
      (
...
static size_t _Camera_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_create_message_types__srv__Camera_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, create_message_types, srv, Camera_Request)() {
...
using _Camera_Response__ros_msg_type = create_message_types__srv__Camera_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_create_message_types
size_t get_serialized_size_create_message_types__srv__Camera_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Camera_Response__ros_msg_type * ros_message = static_cast<const _Camera_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_create_message_types__srv__Camera_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_create_message_types
size_t max_serialized_size_create_message_types__srv__Camera_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = create_message_types__srv__Camera_Response;
    is_plain =
      (
...
static size_t _Camera_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_create_message_types__srv__Camera_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, create_message_types, srv, Camera_Response)() {
...
// already included above
// #include "create_message_types/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "create_message_types/srv/camera.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, create_message_types, srv, Camera)() {
