...
static const _CameraPTZ_Request_type_support_symbol_names_t _CameraPTZ_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, create_message_types, srv, CameraPTZ_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, create_message_types, srv, CameraPTZ_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, create_message_types, srv, CameraPTZ_Request)() {
  return &::create_message_types::srv::rosidl_typesupport_c::CameraPTZ_Request_message_type_support_handle;
}
...
static const _CameraPTZ_Response_type_support_symbol_names_t _CameraPTZ_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, create_message_types, srv, CameraPTZ_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, create_message_types, srv, CameraPTZ_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, create_message_types, srv, CameraPTZ_Response)() {
  return &::create_message_types::srv::rosidl_typesupport_c::CameraPTZ_Response_message_type_support_handle;
}
...
static const _CameraPTZ_type_support_symbol_names_t _CameraPTZ_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, create_message_types, srv, CameraPTZ)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, create_message_types, srv, CameraPTZ)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, create_message_types, srv, CameraPTZ)() {
  return &::create_message_types::srv::rosidl_typesupport_c::CameraPTZ_service_type_support_handle;
}
